      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-8 md:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold mb-3">
            ...
            <span className="neon-text">ResumeIQ</span>
          </h1>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button className="glass-card-bright rounded-xl py-3 flex items-center justify-center gap-3 text-white hover:scale-[1.03] transition-all">
