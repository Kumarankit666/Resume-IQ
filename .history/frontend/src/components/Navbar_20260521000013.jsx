...
const Navbar = () => {
  ...
  const isActive = (to) => {
    ...
    return location.hash === to.split("#")[1]
      ? true
      : false;
  };
            ...
            {user ? (
              ...
              <>
                ...
                <div
                  ...
                  className="flex items-center gap-3 glass-card px-3 py-2 rounded-full cursor-pointer hover:scale-[1.02] transition-all"
                >
            ...
            {user ? (
              ...
              <>
                ...
                <button
                  ...
                  className="btn-ghost-neon rounded-full px-5 py-2.5 text-sm font-semibold text-cyan-100"
                >
                  Profile
                </button>
